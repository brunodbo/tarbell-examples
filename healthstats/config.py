...
GOOGLE_DOC = {
    'key': '0Ak3IIavLYTovdDVNeUlhLW8tN3BpTWoxWkNHOFRvVVE',
}
...
"""
DEFAULT_CONTEXT = {
    'title': 'Chicago Public Health Statistics 1999-2009',
}

"""
Root URL project will appear at (e.g. http://mydomain.tld/)
"""
# URL_ROOT = 'healthstats'
...
# blueprint = Blueprint('healthstats', __name__)
